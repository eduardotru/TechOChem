...
function completed(){
  if(cont>1)
    swal(
      '¡Buen trabajo!',
      `Las reacciones de oxidación son de gran importancia porque son la mayor fuente de energía en el
mundo, ya sea orgánica o inorgánica. Está presente en cualquier composición que contenga
oxígenos. La oxidación de alcoholes a grupos carbonilos también es un paso muy importante en la
degradación de grasa durante el metabolismo humano.`,
      'success'
    )
}
bonds.map((b) => {
